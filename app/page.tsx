...
function LandingContent() {
  ...
  const FEATURES = [
    { icon: "🧮", title: "메뉴별 원가 계산", desc: "식재료 원가 → 원가율·건당 순익 자동 계산", tag: "수익 분석" },
    { icon: "🛵", title: "배달앱 매출 분석", desc: "정산서 업로드 → 수수료·실매출 AI 자동 분석", tag: "AI 도구" },
    { icon: "💳", title: "카드매출 자동 수집", desc: "사업자번호만 입력하면 카드사별 매출 조회", tag: "수익 분석" },
    { icon: "📊", title: "리뷰 감정 분석", desc: "네이버·배민 리뷰 → AI 감정·키워드 분석", tag: "AI 도구" },
    { icon: "📱", title: "SNS 콘텐츠 생성", desc: "메뉴·이벤트 → 인스타 캡션 AI 자동 생성", tag: "AI 도구" },
    { icon: "🧾", title: "세금 계산기", desc: "부가세·종소세 예상액 자동 산출", tag: "수익 분석" },
    { icon: "📄", title: "손익계산서 PDF", desc: "시뮬레이션 데이터 → P&L 리포트 즉시 출력", tag: "창업 준비" },
    { icon: "🗺️", title: "AI 상권 분석", desc: "입지 조건 → 상권 적합도 AI 리포트", tag: "창업 준비" },
    { icon: "📈", title: "매출 예측 AI", desc: "과거 데이터 기반 3개월 매출 자동 예측", tag: "AI 도구" },
  ];
