...
// ── FAQ ──
const FAQS = [
  { q: "VELA는 무료인가요?", a: "기본 기능(시뮬레이터, 대시보드)은 무료입니다. AI 도구와 고급 분석은 Standard 플랜(월 9,900원)부터 이용 가능해요." },
  ...
  { q: "HQ 인트라넷은 뭔가요?", a: "매장 직원들과 함께 쓰는 사내 시스템이에요. 출퇴근 관리, 보고서, 채팅, 결재 등 인트라넷 기능을 제공합니다. 대표 승인 후 직원들이 접속할 수 있어요." },
